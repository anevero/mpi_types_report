...
данных. Три примера, с обычным массивом (contiguous), однородными блоками
массива (vector / hvector) и неоднородными блоками массива (indexed / hindexed),
можно увидеть прямо в коде.
